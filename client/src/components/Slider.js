            ...
            <Wrapper slideIndex={slideIndex}>
                {sliderItems.map((item, index) => (
                    <Slide key={index} layer={item.backgroundLayer}>
                        <ImgContainer>
                            <Img src={item.img} position={item.position} visibility={item.visibility} />
                            <ImgWrap2 layer={item.backgroundLayer2}>
                                <Img2 src={item.img2} position={item.position2} />
                                <InlineInfoWrapper>
                                    <InlineTitle inlineFontSize={item.inlineFontSize}>{item.inlineTitle}</InlineTitle>
                        ...
                        <InfoContainer align={item.align}>
                            ...
                            >
                                ...
                                <Desc>{item.desc}</Desc>
                                <Button visibility={item.visibility} to={`/products/${item.categorySlide}`}>
                                    Shop now
                                </Button>
                            </InfoWrapper>
                            <InlineButton
